...
2. **File → Open…** → `~/java-bootcamp/examples/lab7-answers`  
...
7. **View → Tool Windows → Terminal** → `cd ~/java-bootcamp` then `cd examples/lab7-answers` when ready.
...
| This lab project | `~/java-bootcamp/examples/lab7-answers` |
