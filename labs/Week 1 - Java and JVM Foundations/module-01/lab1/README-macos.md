...
2. **File → Open…** → `~/java-bootcamp/examples/lab1-answers`  
...
7. **View → Tool Windows → Terminal** → `cd ~/java-bootcamp` then `cd examples/lab1-answers` when ready.
...
| This lab project | `~/java-bootcamp/examples/lab1-answers` |
