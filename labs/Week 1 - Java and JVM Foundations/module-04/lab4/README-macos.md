...
**Other OS:** [Windows guide](README-windows.md) · [IDE conventions](../_IDE-CONVENTIONS.md)

- Pre-lab exercises: [`../exercises/`](../exercises/)
## Prerequisites (macOS)

- [Lab 0 (macOS)](../../module-00/lab0/README-macos.md) complete (JDK 21, Maven when needed, Git)
...
2. **File → Open…** → `~/java-bootcamp/examples/lab4-gc-snippet`  
...
7. **View → Tool Windows → Terminal** → `cd ~/java-bootcamp` then `cd examples/lab4-gc-snippet` when ready.
...
| This lab project | `~/java-bootcamp/examples/lab4-gc-snippet` |
