...
2. **File → Open…** → `~/java-bootcamp/examples/lab6-answers`  
...
7. **View → Tool Windows → Terminal** → `cd ~/java-bootcamp` then `cd examples/lab6-answers` when ready.
...
| This lab project | `~/java-bootcamp/examples/lab6-answers` |
