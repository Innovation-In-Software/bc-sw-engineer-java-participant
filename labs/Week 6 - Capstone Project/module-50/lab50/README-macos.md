...
2. **File → Open…** → `~/java-bootcamp/examples/lab50-crm`  
...
7. **View → Tool Windows → Terminal** → `cd ~/java-bootcamp` then `cd examples/lab50-crm` when ready.
...
| This lab project | `~/java-bootcamp/examples/lab50-crm` |
