...
From `examples/module-52-exercises/`, create `notes/` if needed, then create `notes/lab52-packet-index.md`.
...
Defense packet index with folder paths in `notes/lab52-packet-index.md`.

## If it fails

| Problem | Fix |
| --- | --- |
| No file / wrong name | Must be `notes/lab52-packet-index.md` |
