...
2. **File → Open…** → `~/java-bootcamp/examples/customer-management-platform`  
...
7. **View → Tool Windows → Terminal** → `cd ~/java-bootcamp` then `cd examples/customer-management-platform` when ready.
