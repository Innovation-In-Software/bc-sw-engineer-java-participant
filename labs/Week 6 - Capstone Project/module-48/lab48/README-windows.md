...
2. **File → Open…** → `%USERPROFILE%\java-bootcamp\examples\lab48-crm`  
...
7. **View → Tool Windows → Terminal** (PowerShell) → `cd $env:USERPROFILE\java-bootcamp` then `cd examples\lab48-crm` when ready.
...
| This lab project | `%USERPROFILE%\java-bootcamp\examples\lab48-crm` |
