# Lab 38: PostgreSQL SQL and CRM Query Performance — DBMS_XPLAN, Indexes, Sargable Predicates — macOS
...
2. **File → Open…** → `~/java-bootcamp/examples/lab38-crm`  
...
7. **View → Tool Windows → Terminal** → `cd ~/java-bootcamp` then `cd examples/lab38-crm` when ready.
