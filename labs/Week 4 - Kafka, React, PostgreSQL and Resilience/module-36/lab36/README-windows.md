# Lab 36: Frontend Security for the CRM SPA — Windows
...
2. **File → Open…** → `%USERPROFILE%\java-bootcamp\examples\lab36-crm`  
...
7. **View → Tool Windows → Terminal** (PowerShell) → `cd $env:USERPROFILE\java-bootcamp` then `cd examples\lab36-crm` when ready.
...
| This lab project | `%USERPROFILE%\java-bootcamp\examples\lab36-crm` |
