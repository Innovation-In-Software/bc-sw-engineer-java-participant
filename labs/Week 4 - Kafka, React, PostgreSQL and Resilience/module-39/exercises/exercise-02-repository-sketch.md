...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab39-repository-sketch.md` | Pass / Fail |
| 2 | ≥3 customer methods | Pass / Fail |
| 3 | Account-by-customer method | Pass / Fail |
| 4 | Layering note | Pass / Fail |
