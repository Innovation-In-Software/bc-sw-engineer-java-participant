...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab39-todos.md` | Pass / Fail |
| 2 | Entity blanks filled | Pass / Fail |
| 3 | Datasource/Flyway blanks filled | Pass / Fail |
| 4 | Version semantics noted | Pass / Fail |
