...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab30-envelope-sketch.md` | Pass / Fail |
| 2 | Both event types sketched | Pass / Fail |
| 3 | customerId and correlationId present | Pass / Fail |
| 4 | Forward-compat rule written | Pass / Fail |
