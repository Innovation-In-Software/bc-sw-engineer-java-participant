...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab31-error-dlt-notes.md` | Pass / Fail |
| 2 | Retryable example | Pass / Fail |
| 3 | Non-retryable example | Pass / Fail |
| 4 | Replay/ops sentence | Pass / Fail |
