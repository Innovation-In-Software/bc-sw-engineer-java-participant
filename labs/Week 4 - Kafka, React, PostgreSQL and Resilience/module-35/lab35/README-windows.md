...
2. **File → Open…** → `%USERPROFILE%\java-bootcamp\examples\lab35-crm`  
...
7. **View → Tool Windows → Terminal** (PowerShell) → `cd $env:USERPROFILE\java-bootcamp` then `cd examples\lab35-crm` when ready.
