...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab44-cd-vs-cdeploy.md` | Pass / Fail |
| 2 | Both terms defined | Pass / Fail |
| 3 | Gated delivery preferred | Pass / Fail |
| 4 | Digest X answer correct | Pass / Fail |
