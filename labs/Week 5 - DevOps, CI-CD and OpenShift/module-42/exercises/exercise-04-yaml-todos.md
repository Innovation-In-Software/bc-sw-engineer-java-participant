...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab42-yaml-todos.md` | Pass / Fail |
| 2 | Skeleton blanks filled | Pass / Fail |
| 3 | Resources placeholders present | Pass / Fail |
| 4 | No apply claimed | Pass / Fail |
