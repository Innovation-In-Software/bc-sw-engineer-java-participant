...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab40-sast-todo-notes.md` | Pass / Fail |
| 2 | Template filled for read and write paths | Pass / Fail |
| 3 | Fixtures CUS-1001/CUS-1002 used | Pass / Fail |
| 4 | No secrets in notes | Pass / Fail |
