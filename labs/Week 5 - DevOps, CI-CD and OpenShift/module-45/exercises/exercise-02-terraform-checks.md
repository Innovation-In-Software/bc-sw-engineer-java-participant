...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab45-terraform-checks.md` | Pass / Fail |
| 2 | Command order listed | Pass / Fail |
| 3 | Plan reading required | Pass / Fail |
| 4 | Remote state bullets present | Pass / Fail |
