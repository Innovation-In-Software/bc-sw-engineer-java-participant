...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/tx-boundary.md` | Pass / Fail |
| 2 | Service chosen over controller | Pass / Fail |
| 3 | Four internal steps ordered | Pass / Fail |
| 4 | Correlation noted | Pass / Fail |
