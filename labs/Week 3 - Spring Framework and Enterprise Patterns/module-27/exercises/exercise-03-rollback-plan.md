...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/rollback-plan.md` | Pass / Fail |
| 2 | Happy and fail paths contrasted | Pass / Fail |
| 3 | No-log-on-fail stated | Pass / Fail |
| 4 | Swallowed-exception reject rule written | Pass / Fail |
