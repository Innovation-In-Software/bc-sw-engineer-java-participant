...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/acid-crm.md` | Pass / Fail |
| 2 | Four letters explained | Pass / Fail |
| 3 | Force-fail account listed | Pass / Fail |
| 4 | Pre-lab vs lab boundary clear | Pass / Fail |
