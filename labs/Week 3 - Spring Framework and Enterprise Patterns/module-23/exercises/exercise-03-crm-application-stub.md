...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/health-sketch.md` | Pass / Fail |
| 2 | `@SpringBootApplication` and `run` filled | Pass / Fail |
| 3 | Health path and UP recorded | Pass / Fail |
| 4 | No JWT/SOAP scope creep | Pass / Fail |
