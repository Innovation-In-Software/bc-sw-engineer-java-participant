...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab23-application-yml-sketch.md` | Pass / Fail |
| 2 | Name and port present | Pass / Fail |
| 3 | No secret values committed | Pass / Fail |
| 4 | Profile called out as Lab 26 topic | Pass / Fail |
