...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/authn-authz.md` | Pass / Fail |
| 2 | Authn vs authz defined | Pass / Fail |
| 3 | 401/403 examples correct | Pass / Fail |
| 4 | Correlation-not-auth stated | Pass / Fail |
