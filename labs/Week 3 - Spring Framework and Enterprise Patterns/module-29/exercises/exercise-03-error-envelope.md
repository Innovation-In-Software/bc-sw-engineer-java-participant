...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/error-envelope.md` | Pass / Fail |
| 2 | Validation example includes violations/correlation | Pass / Fail |
| 3 | 404 example present | Pass / Fail |
| 4 | No stack traces | Pass / Fail |
