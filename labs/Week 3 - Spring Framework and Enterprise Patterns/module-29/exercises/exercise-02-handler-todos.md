...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab29-handler-todos.md` | Pass / Fail |
| 2 | `@RestControllerAdvice` and statuses filled | Pass / Fail |
| 3 | `@Valid` reminder present | Pass / Fail |
| 4 | Happy-path 200 called out | Pass / Fail |
