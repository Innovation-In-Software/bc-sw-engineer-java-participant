...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab22-readiness.md` | Pass / Fail |
| 2 | Java 21 and Maven versions recorded | Pass / Fail |
| 3 | lab22-crm path is written | Pass / Fail |
| 4 | Clear statement that full lab is not done yet | Pass / Fail |
