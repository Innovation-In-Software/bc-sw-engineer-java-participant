# Lab 19: Integration and UI Testing with Selenium — Northstar CRM Regression Suite — macOS
...
2. **File → Open…** → `~/java-bootcamp/examples/lab19-crm`  
...
7. **View → Tool Windows → Terminal** → `cd ~/java-bootcamp` then `cd examples/lab19-crm` when ready.
