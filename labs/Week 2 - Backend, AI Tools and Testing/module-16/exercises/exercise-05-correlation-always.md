...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab16-correlation-always.md` | Pass / Fail |
| 2 | Success path noted | Pass / Fail |
| 3 | Failure path noted | Pass / Fail |
| 4 | Missing-header policy idea written | Pass / Fail |
