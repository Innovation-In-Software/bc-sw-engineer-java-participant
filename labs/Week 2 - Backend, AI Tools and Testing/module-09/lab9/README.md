...
**Depends on Lab 8.** If packages or Lab 8 compile failed, stop and fix [Lab 8](../../module-08/lab8/README.md). If `java` / `mvn` fail, fix [Lab 0](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/module-00/lab0/README.md) / [SETUP-INSTRUCTIONS.md](../../../SETUP-INSTRUCTIONS.md).
...
Complete the [Labs Setup Instructions](../../../SETUP-INSTRUCTIONS.md), [Lab 0](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/module-00/lab0/README.md), and [Lab 8](../../module-08/lab8/README.md) before this lab. Confirm:
...
Update project `README.md` with a CI section:
...
Answer briefly in project `README.md` or `notes/lab9-answers.md`:
