...
| # | Confirm | Notes |
| --- | --- | --- |
| 1 | File exists at `notes/lab12-equals-vs-eqeq.md` | Pass / Fail |
| 2 | Table plus null-safe row | Pass / Fail |
| 3 | Bad and good snippets present | Pass / Fail |
| 4 | Enum preference noted | Pass / Fail |
