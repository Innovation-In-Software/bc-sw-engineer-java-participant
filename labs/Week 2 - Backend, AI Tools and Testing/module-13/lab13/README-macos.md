# Lab 13: SOAP API Design — Northstar Customer Contract (Contract-First) — macOS
...
2. **File → Open…** → `~/java-bootcamp/examples/lab13-crm`  
...
7. **View → Tool Windows → Terminal** → `cd ~/java-bootcamp` then `cd examples/lab13-crm` when ready.
